...
const Experience = () => {
    ...
    h-screen w-full ">
        ...
        <div className=" pt-16 m-auto w-full  h-full">
        <di className="p">
                <p className="   text-4xl max-w-md font-bold border-b-4 border-gray-800  
                p-2 inline ">
                    Experience</p>
                <p className="">These are the technologies that I've worked with</p>
            </di>
        
            <div className="  grid grid-cols-3 sm:grid-cols-3 gap-3
             text-center py-16 px-5  h-10">

           {
            techno.map(({id,src,title,style,})=>(
               ...
               pt-2 rounded-lg ${style}`} >
                 ...
                 <p className="mt-1 mx-auto">{title}</p>
                </div>
            ))
           }     
