...
const NaBar = () => {
    ...
    return (
         <header className="flex justify-between  items-center w-full h-16 px-4  text-white bg-black fixed">
           <di> 
            <h1 className="text-2xl font-blind ml-2">Mililani Rakhetsi</h1>
           </di>
